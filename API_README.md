...
Returns a dict of metadata generated by the mediaanalysisd process. This includes quality metrics and AI generated captions.

#### <a name="ai_caption">ai_caption</a>

Returns a str of the AI generated caption if one exists, otherwise None. The Photos media analysis process (mediaanalysisd) generates these.
