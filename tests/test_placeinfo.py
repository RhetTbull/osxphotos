...
def test_placeInfo4():
    ...
    place = PlaceInfo4(PLACE_4_NAMES_1, PLACE_4_COUNTRY_1)
...
def test_placeInfo4_eq():
    ...
    place1 = PlaceInfo4(PLACE_4_NAMES_1, PLACE_4_COUNTRY_1)
    place2 = PlaceInfo4(PLACE_4_NAMES_1, PLACE_4_COUNTRY_1)
...
def test_placeInfo4_ne():
    ...
    place1 = PlaceInfo4(PLACE_4_NAMES_1, PLACE_4_COUNTRY_1)
    place2 = PlaceInfo4(PLACE_4_NAMES_2, PLACE_4_COUNTRY_2)
    assert place1 != place2
...
def test_placeInfo4_ne3():
    ...
    place1 = PlaceInfo4(PLACE_4_NAMES_2, PLACE_4_COUNTRY_2)
