...
Some of the export tests rely on photos in my local library and will look for `OSXPHOTOS_TEST_LOCAL=1` to determine if they should run.
...
Some of the "search_info" tests require data from my personal library on Catalina 10.15.7.  The data is generated by running `python3 tests/generate_search_info_test_data.py >tests/search_info_test_data.json`
