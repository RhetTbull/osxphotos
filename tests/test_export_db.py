...
def test_export_db():
    ...
    db.set_exiftool_json_sidecar_for_file(filepath, EXIFTOOL_JSON_DATA, (10, 11, 12))
    assert db.get_exiftool_json_sidecar_for_file(filepath) == (
        EXIFTOOL_JSON_DATA,
        (10, 11, 12),
    )
    db.set_xmp_sidecar_for_file(filepath, XMP_DATA, (13, 14, 15))
    assert db.get_xmp_sidecar_for_file(filepath) == (XMP_DATA, (13, 14, 15))
...
def test_export_db_no_op():
    ...
    db.set_exiftool_json_sidecar_for_file(filepath, EXIFTOOL_JSON_DATA, (10, 11, 12))
    assert db.get_exiftool_json_sidecar_for_file(filepath) == (None, (None, None, None))
    db.set_xmp_sidecar_for_file(filepath, XMP_DATA, (13, 14, 15))
    assert db.get_xmp_sidecar_for_file(filepath) == (None, (None, None, None))
...
def test_export_db_in_memory():
    ...
    assert dbram.get_exiftool_json_sidecar_for_file(filepath) == (
        EXIFTOOL_JSON_DATA,
        (10, 11, 12),
    )
    assert dbram.get_xmp_sidecar_for_file(filepath) == (XMP_DATA, (13, 14, 15))
    ...
    dbram.set_exiftool_json_sidecar_for_file(filepath, "FUBAR", (17, 18, 19))
    dbram.set_xmp_sidecar_for_file(filepath, "FUBAR", (20, 21, 22))
    ...
    assert dbram.get_exiftool_json_sidecar_for_file(filepath) == ("FUBAR", (17, 18, 19))
    assert dbram.get_xmp_sidecar_for_file(filepath) == ("FUBAR", (20, 21, 22))
