...
XMP_DATA = """<!-- Created with osxphotos https://github.com/RhetTbull/osxphotos -->
<x:xmpmeta xmlns:x="adobe:ns:meta/" x:xmptk="XMP Core 5.4.0">
    ...
    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
        ...
        <dc:description>Bride Wedding day</dc:description>
        <dc:title></dc:title>
...
def test_export_db():
    ...
    db.set_exiftool_json_sidecar_for_file(filepath, EXIF_DATA)
    assert db.get_exiftool_json_sidecar_for_file(filepath) == EXIF_DATA
    db.set_xmp_sidecar_for_file(filepath, XMP_DATA)
    assert db.get_xmp_sidecar_for_file(filepath) == XMP_DATA 
    ...
    assert db.get_exiftool_json_sidecar_for_file(filepath2) == EXIF_DATA
    assert db.get_xmp_sidecar_for_file(filepath2) == XMP_DATA
...
def test_export_db_no_op():
    ...
    db.set_exiftool_json_sidecar_for_file(filepath, EXIF_DATA)
    assert db.get_exiftool_json_sidecar_for_file(filepath) is None
    db.set_xmp_sidecar_for_file(filepath, XMP_DATA)
    assert db.get_xmp_sidecar_for_file(filepath) is None
