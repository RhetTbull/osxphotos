"""Test macOS 15.4.1 Photos library"""
...
PHOTOS_DB = "./tests/Test-15.4.1.photoslibrary/database/photos.db"
PHOTOS_DB_PATH = "/Test-15.4.1.photoslibrary/database/Photos.sqlite"
PHOTOS_LIBRARY_PATH = "/Test-15.4.1.photoslibrary"
...
def test_attributes(photosdb):
    ...
    assert p.path.endswith(
        "tests/Test-15.4.1.photoslibrary/originals/D/D79B8D77-BFFC-460B-9312-034F2877D35B.jpeg"
    )
...
def test_attributes_2(photosdb):
    ...
    assert p.path.endswith(
        "tests/Test-15.4.1.photoslibrary/originals/E/E9BC5C36-7CD1-40A1-A72B-8B8FAC227D51.jpeg"
    )
    assert not p.ismissing
