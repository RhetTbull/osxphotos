...
def _process_scoreinfo_5(photosdb):
    ...
    result = cursor.execute(
        ...
        {"NULL" if photosdb._photos_ver == 12310 else f"{asset_table}.ZHIGHLIGHTVISIBILITYSCORE"},
        {"NULL" if photosdb._photos_ver == 12310 else "ZCOMPUTEDASSETATTRIBUTES.ZBEHAVIORALSCORE"},
        ...
        {"NULL" if photosdb._photos_ver == 12310 else "ZCOMPUTEDASSETATTRIBUTES.ZINTERACTIONSCORE"},
