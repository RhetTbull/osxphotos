...
def update_photo_date_time(
    ...
    photo_timezone, _, tz_name  = PhotoTimeZone(library_path=library_path).get_timezone(photo)
    local_delta_sec = get_local_tz(photo_date).utcoffset(photo_date).total_seconds() - photo_timezone
