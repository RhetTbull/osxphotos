...
Variables are also useful for cases where the template language does not permit a desired action or to simplify templates for readability. For examplel,
