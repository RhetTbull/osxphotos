...
class QueryOptions:
    ...
    album: Iterable[str] | None = None
    burst_photos: bool | None = None
    burst: bool | None = None
    cloudasset: bool | None = None
    deleted_only: bool | None = None
    deleted: bool | None = None
    description: Iterable[str] | None = None
    duplicate: bool | None = None
    edited: bool | None = None
    exif: Iterable[tuple[str, str]] | None = None
    external_edit: bool | None = None
    favorite: bool | None = None
    folder: Iterable[str] | None = None
    from_date: datetime.datetime | None = None
    from_time: datetime.time | None = None
    function: list[tuple[callable, str]] | None = None
    ...
    in_album: bool | None = None
    incloud: bool | None = None
    is_reference: bool | None = None
    keyword: Iterable[str] | None = None
    label: Iterable[str] | None = None
    live: bool | None = None
    location: bool | None = None
    max_size: bitmath.Byte | None = None
    min_size: bitmath.Byte | None = None
    missing_bursts: bool | None = None
    missing: bool | None = None
    movies: bool | None = True
    name: Iterable[str] | None = None
    no_comment: bool | None = None
    no_description: bool | None = None
    no_likes: bool | None = None
    no_location: bool | None = None
    no_keyword: bool | None = None
    no_place: bool | None = None
    no_title: bool | None = None
    not_burst: bool | None = None
    not_cloudasset: bool | None = None
    not_edited: bool | None = None
    not_favorite: bool | None = None
    not_hdr: bool | None = None
    not_hidden: bool | None = None
    not_in_album: bool | None = None
    not_incloud: bool | None = None
    not_live: bool | None = None
    not_missing: bool | None = None
    not_panorama: bool | None = None
    not_portrait: bool | None = None
    not_reference: bool | None = None
    not_screenshot: bool | None = None
    not_screen_recording: bool | None = None
    not_selfie: bool | None = None
    not_shared: bool | None = None
    not_slow_mo: bool | None = None
    not_spatial: bool | None = None
    not_time_lapse: bool | None = None
    panorama: bool | None = None
    person: Iterable[str] | None = None
    photos: bool | None = True
    place: Iterable[str] | None = None
    portrait: bool | None = None
    query_eval: Iterable[str] | None = None
    regex: Iterable[tuple[str, str]] | None = None
    screenshot: bool | None = None
    screen_recording: bool | None = None
    selected: bool | None = None
    selfie: bool | None = None
    shared: bool | None = None
    slow_mo: bool | None = None
    spatial: bool | None = None
    time_lapse: bool | None = None
    title: Iterable[str] | None = None
    to_date: datetime.datetime | None = None
    to_time: datetime.time | None = None
    uti: Iterable[str] | None = None
    uuid: Iterable[str] | None = None
    year: Iterable[int] | None = None
    syndicated: bool | None = None
    not_syndicated: bool | None = None
    saved_to_library: bool | None = None
    not_saved_to_library: bool | None = None
    shared_moment: bool | None = None
    not_shared_moment: bool | None = None
    shared_library: bool | None = None
    not_shared_library: bool | None = None
